...
本开发分支已接入首页“联网获取真实公开案例”、发布方持久限频/可恢复等待、静态系统代理自动选择及可选公开服务协议/缓存/报告链路。登录态、简历、个人证据和私人报告默认留本地。公开服务尚未配置部署；Fake-IP、PAC、代理认证和招聘平台实站认证仍未完成，不要把本分支当作“所有 VPN/TUN 已兼容”的正式版本。详见 [第一批交付与验收边界](docs/HYBRID_CORE_PHASE1.md)。以下既有发行记录仍描述此前版本。
